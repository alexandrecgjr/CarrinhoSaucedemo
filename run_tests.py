#!/usr/bin/env python3
"""
Script para executar testes automatizados do Sauce Demo
...
def criar_diretorios():
    ...
    diretorios = ["reports", "screenshots", "reports/allure-results", "reports/allure-report"]
...
def main():
    """Função principal"""
    print("🛒 AUTOMAÇÃO DE TESTES - SAUCE DEMO")
    print("=" * 60)
    ...
    # Executar testes
    sucesso = executar_testes_pytest()
